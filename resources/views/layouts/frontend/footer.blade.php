 <!-- ==============================================
    ** Footer **
    ...
    <script src="{{asset('storage/frontend/assets/bootstrap/js/bootstrap.min.js')}}"></script>
    <script src="{{asset('storage/frontend/assets/select2/js/select2.min.js')}}"></script>
    <script src="{{asset('storage/frontend/assets/matchHeight/js/matchHeight-min.js')}}"></script>
    <script src="{{asset('storage/frontend/assets/bxslider/js/bxslider.min.js')}}"></script>
    <script src="{{asset('storage/frontend/assets/waypoints/js/waypoints.min.js')}}"></script>
    <script src="{{asset('storage/frontend/assets/counterup/js/counterup.min.js')}}"></script>
    <script src="{{asset('storage/frontend/assets/magnific-popup/js/magnific-popup.min.js')}}"></script>
...
<!-- Mirrored from protechtheme.com/edumart/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Jul 2023 08:08:53 GMT -->
</html>
